...
# Quaternion in Isaac Sim is scalar-first: [w, x, y, z]
# This target orientation asks the end effector to point downward in a common grasp-like pose.
target_orientation = np.array([0.0, 1.0, 0.0, 0.0])

print(f"Target cube world position = {target_position}")
print(f"Target orientation (wxyz) = {target_orientation}")
